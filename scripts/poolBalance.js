...
const tokenAddress = '0x34d7d7Aaf50AD4944B70B320aCB24C95fa2def7c';
...
(async () => {
    ...
    console.log("User full token balance is: ", JSON.stringify(await getFullTokenBalance("Uniswap V2 pool token", tokenAddress), null, 4));
    ...
    await decodeDerivateTokensIntoUnderlyings("Uniswap V2 pool token", tokenAddress)
})();