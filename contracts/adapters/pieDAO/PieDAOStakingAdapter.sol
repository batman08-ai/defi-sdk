...
contract PieDAOStakingAdapter is ProtocolAdapter {
    ...
    address internal constant DOUGH =
        0xad32A8e6220741182940c5aBF610bDE99E737b2D;
    address internal constant BALANCER_ETH_20_DOUGH_80 =
        0xFAE2809935233d4BfE8a56c2355c4A2e7d1fFf1A;
    address internal constant UNISWAP_DAI_DEFI =
        0x7aeFaF3ea1b465dd01561B0548c9FD969e3F76BA;
    address internal constant BALANCER_DEFI_70_ETH_30 =
        0x35333CF3Db8e334384EC6D2ea446DA6e445701dF;

    address internal constant BALANCER_ETH_20_DOUGH_80_POOL =
        0x8314337d2b13e1A61EadF0FD1686b2134D43762F;
    address internal constant UNISWAP_DAI_DEFI_POOL =
        0x64964cb69f40A1B56AF76e32Eb5BF2e2E52a747c;
    address internal constant BALANCER_DEFI_70_ETH_30_POOL =
        ...
        returns (uint256)
    {
        if (token == DOUGH) {
            ...
            totalBalance += IStakingRewards(BALANCER_ETH_20_DOUGH_80_POOL)
                .earned(account);
            totalBalance += IStakingRewards(UNISWAP_DAI_DEFI_POOL).earned(
                account
            );
            totalBalance += IStakingRewards(BALANCER_DEFI_70_ETH_30_POOL)
                .earned(account);
