...
contract UniswapV2StakingAdapter is ProtocolAdapter {
    ...
    address internal constant UNI_V2_WBTC_WETH =
        0xBb2b8038a1640196FbE3e38816F3e67Cba72D940;
    address internal constant UNI_V2_WETH_USDT =
        0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852;
    address internal constant UNI_V2_USDC_WETH =
        0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc;
    address internal constant UNI_V2_DAI_WETH =
        0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11;

    address internal constant UNI_V2_WBTC_WETH_POOL =
        0xCA35e32e7926b96A9988f61d510E038108d8068e;
    address internal constant UNI_V2_WETH_USDT_POOL =
        0x6C3e4cb2E96B01F4b866965A91ed4437839A121a;
    address internal constant UNI_V2_USDC_WETH_POOL =
        0x7FBa4B8Dc5E7616e59622806932DBea72537A56b;
    address internal constant UNI_V2_DAI_WETH_POOL =
        ...
        returns (uint256)
    {
        if (token == UNI) {
            ...
            totalRewards += IStakingRewards(UNI_V2_WBTC_WETH_POOL).earned(
                account
            );
            totalRewards += IStakingRewards(UNI_V2_WETH_USDT_POOL).earned(
                account
            );
            totalRewards += IStakingRewards(UNI_V2_USDC_WETH_POOL).earned(
                account
            );
            totalRewards += IStakingRewards(UNI_V2_DAI_WETH_POOL).earned(
                account
            );
