...
contract MstableStakingAdapter is ProtocolAdapter {
    ...
    address internal constant BALANCER_MUSD_MTA_20_80 =
        0x003a70265a3662342010823bEA15Dc84C6f7eD54;
    address internal constant BALANCER_USDC_MUSD_50_50 =
        0x72Cd8f4504941Bf8c5a21d1Fd83A96499FD71d2C;
    address internal constant BALANCER_MUSD_MTA_95_5 =
        0xa5DA8Cc7167070B62FdCB332EF097A55A68d8824;
    address internal constant BALANCER_WETH_MUSD_50_50 =
        0xe036CCE08cf4E23D33bC6B18e53Caf532AFa8513;
    address internal constant UNISWAP_MTA_WETH =
        0x0d0d65E7A7dB277d3E0F5E1676325E75f3340455;

    address internal constant EARN_POOL =
        0x881c72D1e6317f10a1cDCBe05040E7564E790C80;
    address internal constant EARN_POOL_2 =
        0xf7575D4D4DB78F6Ba43C734616C51E9fD4bAA7fb;
    address internal constant EARN_POOL_3 =
        0x25970282aAC735Cd4c76f30BfB0Bf2BC8DAD4e70;
    address internal constant EARN_POOL_4 =
        0xf4a7d2d85F4BA11B5C73c35E27044c0c49F7f027;
    address internal constant EARN_POOL_5 =
        ...
        returns (uint256)
    {
        if (token == MTA) {
            ...
            uint256 reward;
            (reward, ) = IStakingRewardsWithPlatformToken(EARN_POOL).earned(
                account
            );
            totalRewards += reward;
            (reward, ) = IStakingRewardsWithPlatformToken(EARN_POOL_2).earned(
                account
            );
            totalRewards += reward;
            (reward, ) = IStakingRewardsWithPlatformToken(EARN_POOL_3).earned(
                account
            );
            totalRewards += reward;
            (reward, ) = IStakingRewardsWithPlatformToken(EARN_POOL_4).earned(
                account
            );
            totalRewards += reward;
            totalRewards += IStakingRewards(EARN_POOL_5).earned(account);
            return totalRewards;
        } else if (token == BAL) {
            uint256 totalRewards = 0;
            uint256 reward;
