...
contract SynthetixAssetAdapter is ProtocolAdapter {
    ...
    address internal constant CURVE_SUSD =
        0xC25a3A3b969415c80451098fa907EC722572917F;
    address internal constant CURVE_SBTC =
        0x075b1bb99792c9E1041bA13afEf80C91a1e70fB3;
    address internal constant IETH = 0xA9859874e1743A32409f75bB11549892138BBA1E;
    address internal constant UNISWAP_SETH =
        0xe9Cf7887b93150D4F2Da7dFc6D502B216438F244;
    address internal constant UNISWAP_SXAU =
        0x34a0216C5057bC18e5d34D4405284564eFd759b2;
    address internal constant BALANCER_SNX_USDC =
        0x815F8eF4863451f4Faf34FBc860034812E7377d9;
    address internal constant BALANCER_SNX_REN =
        0x330416C863f2acCE7aF9C9314B422d24c672534a;
    address internal constant LP_REWARD_SUSD =
        0xDCB6A51eA3CA5d3Fd898Fd6564757c7aAeC3ca92;
    address internal constant LP_REWARD_IETH =
        0xC746bc860781DC90BBFCD381d6A058Dc16357F8d;
    address internal constant LP_REWARD_SETH =
        0x48D7f315feDcaD332F68aafa017c7C158BC54760;
    address internal constant LP_REWARD_SXAU =
        0x8302FE9F0C509a996573D3Cc5B0D5D51e4FDD5eC;
    address internal constant LP_REWARD_SBTC =
        0x13C1542A468319688B89E323fe9A3Be3A90EBb27;
    address internal constant LP_REWARD_BALANCER =
    ...
    {
        if (token == SNX) {
            uint256 balance = Synthetix(Proxy(SNX).target()).collateral(
                account
            );
            balance += IStakingRewards(LP_REWARD_SUSD).earned(account);
            balance += IStakingRewards(LP_REWARD_IETH).earned(account);
            balance += IStakingRewards(LP_REWARD_SETH).earned(account);
            balance += IStakingRewards(LP_REWARD_SXAU).earned(account);
            balance += IStakingRewards(LP_REWARD_BALANCER).earned(account);
            return balance;
        } else if (token == BALANCER_SNX_REN) {
            return IStakingRewards(LP_REWARD_SBTC).earned(account);
